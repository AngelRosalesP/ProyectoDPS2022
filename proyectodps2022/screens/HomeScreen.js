  ...
  return (
    <View style={styles.Header}>
      ...
      >
        ...
        <Path
          d={"M130.5 40 Q150.5 "+(40-inc/2 - peso*grasa/500)+" 167 50          Q190 "+(50-inc- peso*grasa/300)+" 210 55.5          Q"+(220+ peso*grasa/500)+" "+(55.5-(inc/2)- peso*grasa/400)+" 253 57          V71"+
          "Q220 "+(70+inc/2 + peso*grasa/300)+" 210 68          Q188 "+(70+inc/2 + peso*grasa/300)+" "+(160+inc*0.2)+" 65          Q"+(159 + peso*grasa/(100*nivel))+" "+(100+ peso*grasa/(200*nivel))+" "+(159+ peso*grasa/(500*nivel))+" 120          Q"+(158 + inc + peso*grasa/(200*nivel)) +" 160 "+(158+inc/9+ peso*grasa/500)+" 170 Q158 190 159 200 Q"+(158+inc+ peso*grasa/500)+" 230 155 257"+
          "H145"+
          "Q "+(150-inc- peso*grasa/400)+" 210 145 200      "+
          "Q"+(138-inc/1.5 - peso*grasa/400)+" 165 129 145"
          }
          fill="#393704"
          stroke="cyan"
          id="Grasa"
        ...
        <Path
          ...
          />
          <Path
            d={"M253 61 L230.5 62.5L212 59 Q222.5 " + (55.5 - inc/2) + " 253 61Z"}
            fill="#C96363"
            id="Path8811"
            stroke="#A12C2C"
          />
          <Path
            d={
              "M253 67.5L226.5 64.5L212 66 Q222.5 " + (69.5 + inc/2) + " 253 67.5"
            }
            fill="#C96363"
            id="Path8813"
            stroke="#A12C2C"
          />
          <Path
            d={"M153 74 L146 "+(83-inc/4)+" V "+(85+inc/4)+" L158.5 "+(75+inc/3)+" V66L153 74Z"}
            fill="#C96363"
            stroke="#A12C2C"
            id="Path8819"
          />
          <Path
          d={"M158 80.5 L146.5 "+(95-inc/3)+" V"+(95+inc/4)+" L 156.5 "+(91.5+inc/4)+"L158 84.5Z"}
          fill="#C96363"
          stroke="#A12C2C"
          id="Path8821"
        />
        <Path
          d={"M156.5 94.5 L146 "+(103-inc/3)+"  V"+(105+inc/5)+"  L154.5 101.5  L156.5 94.5 Z"}
          fill="#C96363"
          stroke="#A12C2C"
          id="Path8823"
        />
        ...
        <Path
          d={"M154 "+(108-inc/3)+" L146.5 "+(115-inc/3)+" L144.5 "+(120+inc/3)+" L154 "+(114+inc/3)+"Z"}
          fill="#C96363"
          stroke="#A12C2C"
          id="Path8825"
        />
